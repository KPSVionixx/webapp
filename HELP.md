...
* The original package name 'com.praveen.springboot.web.springboot-first-web-application' is invalid and this project uses 'com.praveen.springboot.web.springbootfirstwebapplication' instead.
